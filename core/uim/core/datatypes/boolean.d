...
Json ifBoolean(Json obj, string key, Json booleanValue) {
  return obj.hasKey(key, false) && obj[key].isBoolean ? booleanValue : obj[key];
}

Json ifBoolean(Json[string] map, string key, Json booleanValue) {
  return map.hasKey(key, false) && map[key].isBoolean ? booleanValue : map[key];
}
...
Json ifNotBoolean(Json obj, string key, Json notBooleanValue) {
  return obj.hasKey(key, false) && obj[key].isBoolean ? obj[key] : notBooleanValue;
}

Json ifNotBoolean(Json[string] map, string key, Json notBooleanValue) {
  return map.hasKey(key, false) && map[key].isBoolean ? map[key] : notBooleanValue;
}
