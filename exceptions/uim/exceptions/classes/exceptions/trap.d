...
class DExceptionTrap : UIMObject {
    ...
    IErrorLogger logger() {
        /** @var class-string<uim.exceptions.IErrorLogger> aclassname */
 ...
 */    }
     ...
     *
     * By triggering an exceptions.USER_ERROR we can end up in the default
    ...
    void logInternalError(Throwable exceptionToLog) {
        ...
        trigger_error(message, exceptions.USER_ERROR); */
    }
}
